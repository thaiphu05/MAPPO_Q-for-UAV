...
#                             continue
#                         local_binds = {
#                             k: v for k, v in binds.items() if k in param.parameters
#                         }
#                         bind_list = [
#                             dict(zip(local_binds, t))
#                             for t in zip(*local_binds.values())
#                         ]
...
#         else:
#             qobj = self._assemble(
#                 circuits, parameter_binds=parameter_binds, **run_options
#             )
#
#         # Optional validation
#         if validate:
